...
size_t N = 15; //T= N *dt and T should be a few seconds
double dt = 0.05;  //dt should be as small as possible
//12, 0.05 best
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // Referenced to the quiz in the class.
...
//  size_t i;
  ...
  for(unsigned int n=0; n<N-2; n++){
    ...
    solution_x.push_back(solution.x[delta_start + n + 1]);
    solution_x.push_back(solution.x[a_start + n + 1]);
  }
  return solution_x;
